...
class Settings(BaseSettings):
    ...
    # 55433, как в docker-compose.yml. На 55432 на машине разработчика стоит чужая база
    # (соседний проект), и умолчание, совпавшее с ней, уводило тесты без .env туда.
    db_port: int = 55433
    db_name: str = "orbita"
    db_user: str = "orbita"
    ...
    # Порогов сигналов («горит», «молчит», время сводки) здесь нет и не будет: это данные,
    # которые меняет помощник без выкладки (ТЗ 3.9), и живут они в справочнике `settings`
