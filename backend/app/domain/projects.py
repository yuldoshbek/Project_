...
class Classification(StrEnum):
    ...
    Граница проходит по периметру системы, а не между пользователями: внутри оба
    пользователя видят всё, наружу `restricted` не уходит **никогда** — ни в Google, ни в
    Telegram, ни в SETA, ни в экспорт, ни счётчиком в поиске
