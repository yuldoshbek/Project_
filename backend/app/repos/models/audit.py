...
class Auditable:
    ...
    audit_is_classified: bool = False
    """Содержимое закрыто и в журнал не выдаётся (ADR-0007).

    Здесь всегда `False`: у сущностей основания нет грифа. Проекты переопределяют это
    свойством, считающим `classification`, в ORB-011.
    """
