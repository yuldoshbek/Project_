  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: '/',
        display: 'standalone',
        // Значения переписаны из токенов светлой темы (--surface-app, --space-deep):
        // манифест читается без CSS, переменных в нём нет. Цвет фона у манифеста один, и
        // экран запуска светлый в обеих темах.
